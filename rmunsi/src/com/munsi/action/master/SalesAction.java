	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(operation != null){
			...
			switch (fetchBy.toUpperCase()) {
				case "CODE":
					json = CommonUtil.getProductByCode(value, Boolean.valueOf(withReferences));
					break;
				case "BARCODE" :
					json = CommonUtil.getProductByBarCode(value, Boolean.valueOf(withReferences));
					break;
				case "NAME" :
					json = CommonUtil.getProductByName(value, Boolean.valueOf(withReferences));
					break;
				default:
					break;
				}
