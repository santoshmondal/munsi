...
public interface AreaDao extends BaseDao{
		 ...
		 * @return instance of AreaDao
		 */
		public Area get(String _id);
		
		
		/**
		 * @param _id Area id to be loaded
		 * @param withReferences - Boolean, if true Area object load its references, if false 
		...
		/**
		 * Get list of Area instance, Area instance does not load references instance,
		 * @return ArraList of Area
		 */
