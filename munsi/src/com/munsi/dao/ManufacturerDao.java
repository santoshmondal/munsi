...
public interface ManufacturerDao {
	 ...
	 *            - Boolean, if true Manufacturer object load its references, if
	 *            false Manufacturer object does not load its references.
	 *            (default is false)
	 ...
	 * @param withReferences
	 *            - Boolean, if true Manufacturer object load its references, if
	 *            false Manufacturer object does not load its
