...
public interface MainAccountDao extends BaseDao{
		...
		/**
		 * Get MainAccount instance, MainAccount instance does not load references instance,  
		 * @param _id MainAccountDao id to be loaded
		...
		/**
		 * @param _id MainAccount id to be loaded
		 * @param withReferences - Boolean, if true MainAccount object load its references, if false 
		 * MainAccount object does not load its references. (default is false)
		...
		/**
		 * Get list of MainAccount instance, MainAccount instance does not load references instance,
		 * @return ArraList of MainAccount
		 */
