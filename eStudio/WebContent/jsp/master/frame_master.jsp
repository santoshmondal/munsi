...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									View, Add and Edit Frame details.
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<table id="grid-table-frame"></table>

								<div id="grid-pager-frame"></div>
	...
	<script type="text/javascript">
			...
			jQuery(function($) {
				var grid_selector = "#grid-table-frame";
				var pager_selector = "#grid-pager-frame";
			
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					
					url: "${pageContext.request.contextPath}/masteraction.do?op=view_all&type=frame",
					mtype: "POST",
					rownumbers:true,
					loadonce: true,
					gridview: true,
					...
					colModel:[
						...
						{name:'direct',index:'direct', width:110, editrules:{required:true,number:true}, editable: true},
						{name:'mount',index:'mount', width:110, editrules:{required:true,number:true}, editable: true},
						{name:'rightMount',index:'rightMount', width:110, editrules:{required:true,number:true}, editable: true},
						{name:'leftMount',index:'leftMount', width:110, editrules:{required:true,number:true}, editable: true},
						{name:'goldMount',index:'goldMount', width:110, editrules:{required:true,number:true}, editable: true},
						{name:'pastting',index:'pastting', width:110, editrules:{required:true,number:true}, editable: true},
						{name:'description',index:'description', width:150,editable: true,editoptions:{maxlength:"200"}},
						{name:'myac',index:'', width:80, fixed:true, sortable:false, resize:false,
							formatter:'actions', 
							formatoptions:{ 
								keys:true,
								delOptions:{recreateForm: true,url: "${pageContext.request.contextPath}/masteraction.do?op=delete&type=frame",  beforeShowForm:beforeDeleteCallback},
					...
					editurl: "${pageContext.request.contextPath}/masteraction.do?op=edit&type=frame",
					scrollOffset: 18,
					autowidth: true
				});
