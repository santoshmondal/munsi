...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									View, Add and Edit Photo details.
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<table id="grid-table-photo"></table>

								<div id="grid-pager-photo"></div>
	...
	<script type="text/javascript">
			...
			jQuery(function($) {
				var grid_selector = "#grid-table-photo";
				var pager_selector = "#grid-pager-photo";
				...
				jQuery(grid_selector).jqGrid({
					...
					editurl: "${pageContext.request.contextPath}/masteraction.do?op=edit&type=photo",
					scrollOffset: 18,
					autowidth: true
				});
				...
				jQuery(grid_selector).jqGrid('navGrid',pager_selector,
					...
					},
					{
						...
						closeAfterAdd: true,
						recreateForm: true,
						url: "${pageContext.request.contextPath}/masteraction.do?op=add&type=photo",
