<div class="sidebar sidebar-fixed" id="sidebar">
		...
		<ul class="nav nav-list">
			<li class="active" ><a href="#"> <i	class="icon-dashboard"></i> 
					<span class="menu-text" data-href="embed.jsp"> Dashboard </span>
			</a></li>

			<li><a href="#"> <i class="icon-text-width"></i>
					<span class="menu-text" data-href="embed1.jsp"> Typography </span>
			</a></li>

			<li><a href="#" class="dropdown-toggle"> <i	class="icon-desktop"></i> 
					<span class="menu-text"> UI	Elements </span> <b class="arrow icon-angle-down"></b>
				</a>

				<ul class="submenu">
					<li><a href="#"  data-href="embed2.jsp"> <i
