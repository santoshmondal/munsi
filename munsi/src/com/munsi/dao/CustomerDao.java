...
public interface CustomerDao extends BaseDao{
		...
		/**
		 * Get Customer instance, Customer instance does not load references instance,  
		 * @param _id customer id to be loaded
		...
		/**
		 * @param _id customer id to be loaded
		 * @param withReferences - Boolean, if true customer object load its references, if false 
		 * customer object does not load its references. (default is false)
		...
		/**
		 * Get list of Customer instance, Customer instance does not load references instance,
		 * @return ArraList of customers
		 */
