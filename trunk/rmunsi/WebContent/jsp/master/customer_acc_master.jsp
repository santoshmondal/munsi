	...
	<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					height: 366,
					colNames:['id','Name','Credit Limit','Credit Days','Outstanding Amount','Address','City','Pin Code','E-mail','Telephone','Mobile',' '],
					colModel:[
						...
						{name:'creditLimit',index:'creditLimit', width:150,editable: true,editrules:{number:true},editoptions:{size:"20",maxlength:"130"}},
						{name:'creditDays',index:'creditDays', width:110,editrules:{number:true}, editable: true},
						{name:'outStandingAmount',index:'outStandingAmount',editrules:{number:true}, width:110, editable: true},
